...
python3 -m pylint $bert_files --rcfile ../.pylintrc --disable=missing-docstring --confidence=HIGH,INFERENCE,INFERENCE_FAILURE || fail 'LINTING BERTS'
...
echo 'PEP8'
python3 -m pycodestyle . --max-line-length 140 --exclude 'testbert.py' || fail 'PEP8'
